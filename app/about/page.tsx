...
export const metadata: Metadata = {
  title: 'About Us | Our Story, Values & Waldorf Philosophy',
  description: 'Learn about Kidz Safari preschool in Greenfield Colony, Faridabad. Founded by Mrs. Anjali Bansal with 15+ years of experience. Our Waldorf holistic approach nurtures warmth, wonder, togetherness, and growth in every child ages 2 to 6.',
  alternates: { canonical: 'https://kidzsafari.in/about' },
};
